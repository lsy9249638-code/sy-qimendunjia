...
A personal Qimen Dunjia hour-chart plotting and forecasting tool the owner fully controls, publishable to their own domain.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "238494115+lsy9249638-code@users.noreply.github.com"
  git config user.name "lsy9249638-code"
  ```
